...
**/
inline int Apolo_writeString(char *buffer, const char *cad){
	int n=0,len;
	if(cad!=0){ //not null
...
int ApoloMessage::writeSetRobotJoints(char *buffer, const char *world, const char *robot, int num, double *values)
{
	int n=0;
