...
bool IKwristSOL(double* q, double x, double y, double z, bool elbow);
...
int main() {
    ...
    file << "X\tQ1\tQ2\tQ3\tX\tQ1\tQ2\tQ3" << std::endl;
...
bool IKwrist(double* q, double x, double y, double z, bool elbow)
{
    ...
    double num = abs( x * x + y * y + z * z - Lc * Lc - Ld * Ld); //positive q3 (elbow up)
